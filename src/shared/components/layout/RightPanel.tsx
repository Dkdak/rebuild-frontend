...
import { formatCurrency, formatManwon, formatRecentTrade, GRADE_CLASS } from "../../../features/search/api/searchApi";
                ...
                {analysisLoading && analysis == null ? (
                    ...
                    <>
                        ...
                        <dl className="right-panel-fact-list">
                            <div>
                                <dt>최근 실거래가</dt>
                                <dd>{selected.recentTrade?.price != null ? formatManwon(selected.recentTrade.price) : "해당 없음"}</dd>
                            </div>
                            <div>
                        ...
                        {selected.recentTrade?.price != null && (
                            <>
                                ...
                                {(formatContractMonth(selected.recentTrade.contractDate) || recentTradeFlags?.isPartial) && (
                                    <p className="right-panel-market-cell-aux">
